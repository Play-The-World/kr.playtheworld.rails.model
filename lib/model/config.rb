module Model
  module Config
    ...
    # Key: Default Value
    CONFIGS = {
      achievement: ModelConfiguration.new("Model::Achievement::Base", "model_achievements"),
      ...
      clue: ModelConfiguration.new("Model::Clue::Base", "model_clues"),
      character: ModelConfiguration.new("Model::Character::Base", "model_characters"),
      game_stat: ModelConfiguration.new("Model::GameStat::Base", "model_game_stats"),
      map_area: ModelConfiguration.new("Model::MapArea::Base", "model_map_areas"),
      otp_digits: 6,
