...
sl = Model::StageList::Ready.create!(
  theme_data: td,
  number: 1,
...
eg.conditions.create!({
  ...
  type: 'Model::Condition::OnNextStageList',
  conditioner: sl,
})

sls[0].branches.create!(
  target_stage_list: sls[1]
)
...
begin
  ...
  # Production용
  a = Model::Application.first_or_create!(mode: :production)
  topic = Model::Topic::Custom.first_or_create!(
    title: "#크라임씬"
  )
